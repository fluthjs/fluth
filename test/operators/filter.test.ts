...
import { consoleSpy, errorSpy } from '../utils'
...
describe('filter operator test', async () => {
  ...
  test('test filter operator with value-based condition', () => {
    const stream$ = $()
  ...
  test('test filter with always true condition', () => {
    const stream$ = $()
  ...
  test('test filter with always false condition', () => {
    const stream$ = $()
  ...
  test('test filter with type-based condition', () => {
    const stream$ = $()
  ...
  test('test filter with complex object condition', () => {
    const stream$ = $()
  ...
  test('test filter with error handling', () => {
    const stream$ = $()
